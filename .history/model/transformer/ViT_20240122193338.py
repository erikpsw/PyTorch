...
class Transformer(nn.Module):
    def __init__(self, d_model, num_heads, num_layers, d_ff, max_seq_length, dropout):
        ...
        self.fc = nn.Linear(d_model, 10) # 转成词汇的分布
...
train_x=nn.functional.unfold(train_x,kernel_size=(patch_size,patch_size),stride=patch_size).transpose(-1,-2)

transformer=Transformer(16,2,3,10,49,0.1)
